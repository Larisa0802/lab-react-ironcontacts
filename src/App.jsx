...
function App() {
    ...
    return (
        <main className="App">
            ...
            <button class="btn" onClick={getRandomContact}>Add Random Contact</button>
            <button class="btn" onClick={sortByName}>Sort contact by name</button>
            <button class="btn" onClick={sortByPopularity}>Sort contact by popularity</button>
